...
<?php
/*  
Template Name: Page Section Extra Narrow with Centered Title
					...
					<div class="inner-wrap">
						...
						if (($sectionInfo['sectionAside'] != 'no-sidebar') || (!empty($sectionInfo['sectionAside']))) {
							...
							<div class="content row <?=((!empty($sectionInfo['rowAlignment'])) ? $sectionInfo['rowAlignment'] : 'justify-content-center')?>">
								<div class="<?=((!empty($sectionInfo['contentColumns'])) ? $sectionInfo['contentColumns'] : 'col-12 col-lg-11')?> content <?=$sectionInfo['sectionContentInnerClass']?>">
							<?php
						}
