<?php defined('ABSPATH') or die('No Hackers!'); ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 order-12 col-sm-6 order-sm-1 left">
						...
						<p id="copyright">&copy;<?=date('Y')?> <?php bloginfo('name'); ?> All Rights Reserved.</p>
					</div>
	...
	<a href="#top" id="link-top" class="d-flex align-items-center justify-content-center icon-link scroll-top" title="Back to Top" aria-label="Back to Top" role="button"><i class="fal fa-light fa-angle-up"></i></a>
    </div><!-- /#page-wrapper -->
	<?php
